...
class TestRow11:
    ...
    def test_first_meshes_map_to_second_row(self, r11, r21):
        assert r11.get_consuming_row_and_index(0) == (r21, 0)
        assert r11.get_consuming_row_and_index(1) == (r21, 1)

    def test_middle_mesh_does_not_map_to_any_row(self, r11):
        assert r11.get_consuming_row_and_index(2) is None

    def test_right_meshes_map_to_third_row(self, r11, r22):
        assert r11.get_consuming_row_and_index(3) == (r22, 0)
        assert r11.get_consuming_row_and_index(4) == (r22, 1)
...
class TestMappingErrors:
    ...
    def test_lower_indices_create_error(self, r11):
        with raises(IndexError):
            r11.get_consuming_row_and_index(-1)

    def test_higher_indices_create_error(self, r11):
        with raises(IndexError):
            r11.get_consuming_row_and_index(5)


class TestRow21:

    def test_all_meshes_map_to_last_row(self, r21, r41):
        assert r21.get_consuming_row_and_index(0) == (r41, 0)
        assert r21.get_consuming_row_and_index(1) == (r41, 1)
...
class TestRow22:
    ...
    def test_all_meshes_map_to_row_3(self, r22, r32):
        assert r22.get_consuming_row_and_index(0) == (r32, 0)
        assert r22.get_consuming_row_and_index(1) == (r32, 1)


class TestRow32:

    def test_all_meshes_map_to_last_row(self, r32, r41):
        assert r32.get_consuming_row_and_index(0) == (r41, 3)
        assert r32.get_consuming_row_and_index(1) == (r41, 4)
...
class TestRow41:
    ...
    def test_row_maps_to_nowhere(self, r41):
        for i in range(4):
            assert r41.get_consuming_row_and_index(i) is None
