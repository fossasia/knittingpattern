...
class Row(Prototype):
    ...
    def produce_number_of_meshes_for_row(self, start_index,
        ...
        for mesh_index in range(start_index, stop_index):
            self.set_consuming_row_and_index(mesh_index, row, mesh_index_in_row)
            mesh_index_in_row += 1
    ...
    def remove_consuming_row_and_index(self, mesh_index):
        ...
        row._remove_producing_row_and_index(mesh_index_in_row, self, mesh_index)
    ...
    def _remove_producing_row_and_index(self, mesh_index, row, mesh_index_in_row):
    ...
    def remove_producing_row_and_index(self, mesh_index):
        ...
        expected_row, expected_mesh_index = row.get_consuming_row_and_index(mesh_index_in_row)
