...
class ProducedMesh(object):
    ...
    def __init__(self, producing_instruction, mesh_index_in_producing_instruction):
        self._producing_instruction = producing_instruction
        self._mesh_index_in_producing_instruction = mesh_index_in_producing_instruction
    ...
    def mesh_index_in_producing_row(self):
        return self.producing_instruction.index_of_first_produced_mesh_in_rows_produced_meshes + \
    ...
    def consuming_instruction(self):
        row, index = self.consuming_row_and_index
...
class ConsumedMesh(object):
    ...
    def __init__(self, consuming_instruction, mesh_index_in_consuming_instruction):
        self._consuming_instruction = consuming_instruction
        self._mesh_index_in_consuming_instruction = mesh_index_in_consuming_instruction
